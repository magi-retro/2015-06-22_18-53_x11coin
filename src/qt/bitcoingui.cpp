...
{
    resize(850, 550);
    setWindowTitle(tr("Magi") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Magi address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Magi"), this);
